...
// Enhanced Typography with proper hierarchy for task tracking app
val AppTypography = Typography(
    ...
    // Section headers (day grouping, settings sections)
